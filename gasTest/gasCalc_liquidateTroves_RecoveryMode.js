...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 USDE
    ...
    //1 accts open Trove with 1 ether and withdraw 100 USDE
    ...
    // Account 500 opens with 1 ether and withdraws 100 USDE
    ...
    // Check initial troves with starting 10E/90USDE are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 USDE
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 USDE
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 USDE
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 USDE
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 USDE
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ether and withdraw 100 USDE
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 USDE
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 USDE
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 USDE
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion USDE
    ...
    // Check SP has 9e28 USDE
    const USDEinSP = (await stabilityPool.getTotalUSDEDeposits()).toString()
    assert.equal(USDEinSP, dec(9, 28))

    //1 acct opens Trove with 1 ether and withdraw 100 USDE
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'ether'), dec(60, 18))
    ...
    // Check initial troves with starting 10E/90USDE, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
    assert.isTrue(await sortedTroves.contains(whale))

    //Check USDE in SP has decreased but is still > 0
    const USDEinSP_After = await stabilityPool.getTotalUSDEDeposits()
    assert.isTrue(USDEinSP_After.lt(web3.utils.toBN(dec(9, 28))))
    assert.isTrue(USDEinSP_After.gt(web3.utils.toBN('0')))
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 USDE
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 USDE
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 USDE
