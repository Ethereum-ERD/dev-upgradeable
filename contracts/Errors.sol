...
library Errors {
    ...
    string public constant SEND_ETH_FAILED = "103"; // 'Length mismatch'

    string public constant CALLER_NOT_AP = "200"; // 'Caler is not ActivePool'
    string public constant CALLER_NOT_BO = "201"; // 'Caler is not BorrowerOperations'
    string public constant CALLER_NOT_CM = "202"; // 'Caler is not CollateralManager'
    string public constant CALLER_NOT_SP = "203"; // 'Caler is not Stability Pool'
    string public constant CALLER_NOT_TM = "204"; // 'Caler is not TroveManager'
    string public constant CALLER_NOT_TML = "205"; // 'Caler is not TroveManagerLiquidations'
    string public constant CALLER_NOT_TMR = "206"; // 'Caler is not TroveManagerRedemptions'
    string public constant CALLER_NOT_TML_TMR = "207"; // 'Caler is neither TroveManagerLiquidations nor TroveManagerRedemptions'
    string public constant CALLER_NOT_BO_TM = "208"; // 'Caler is neither BorrowerOperations nor TroveManager'
    string public constant CALLER_NOT_BO_TML_TMR = "209"; // 'Caler is neither BorrowerOperations nor TroveManagerLiquidations nor TroveManagerRedemptions'
    string public constant CALLER_NOT_BO_TMR = "210"; // 'Caler is neither BorrowerOperations nor TroveManagerRedemptions'
