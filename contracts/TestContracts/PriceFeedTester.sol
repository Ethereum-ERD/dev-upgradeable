 ...
 * Chainlink oracle.
 */
contract PriceFeedTester is OwnableUpgradeable, BaseMath, IPriceFeed {
    ...
    function setAddresses(
        ...
        _requireIsContract(_priceAggregatorAddress);
        _requireIsContract(_tellorCallerAddress);
    ...
    function _chainlinkPriceChangeAboveMax(
        ...
        uint256 minPrice = ERDMath._min(currentScaledPrice, prevScaledPrice);
        uint256 maxPrice = ERDMath._max(currentScaledPrice, prevScaledPrice);
