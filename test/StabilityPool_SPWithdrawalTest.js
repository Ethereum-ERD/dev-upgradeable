...
contract('StabilityPool - Withdrawal of stability deposit - Reward calculations', async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).div(_dec(11)).toString(), '66666666666'), 10000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(11)).toString(), '66666666666'), 10000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_dec(11)).toString(), '66666666666'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).div(_dec(11)).toString(), '33333333333'), 10000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(11)).toString(), '33333333333'), 10000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_dec(11)).toString(), '33333333333'), 10000)
    ...
    it("withdrawFromSP():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).toString(), '0'), 10000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '0'), 10000)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing EUSD", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(100000, 18)), whale, whale, {
        from: whale,
        value: dec(100000, 'ether')
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).toString(), '6000000000000000000000'), _1e15BN)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).toString(), '6000000000000000000000'), _1e15BN)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '6000000000000000000000'), _1e15BN)
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing EUSD", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(100000, 18)), whale, whale, {
        from: whale,
        value: dec(100000, 'ether')
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).toString(), '4000000000000000000000'), toBN(dec(1, 16)))
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).toString(), '4000000000000000000000'), toBN(dec(1, 16)))
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '4000000000000000000000'), toBN(dec(1, 16)))
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).toString(), '6666666666666666666666'), toBN(dec(1, 16)))
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).toString(), '13333333333333333333333'), toBN(dec(1, 16)))
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '20000000000000000000000'), toBN(dec(1, 16)))
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).toString(), '5000000000000000000000'), toBN(dec(1, 16)))
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).toString(), '10000000000000000000000'), toBN(dec(1, 16)))
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '15000000000000000000000'), toBN(dec(1, 16)))
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      */
      ...
      // ()
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).toString(), '901719380174061000000'), _dec(16))
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(16)).toString(), '20559199'), 10)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '5906261940140100000000'), _dec(16))
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 EUSD.  A, B, C, D withdraw correct EUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(100000, 18)), whale, whale, {
        from: whale,
        value: dec(100000, 'ether')
      ...
      console.log()
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).div(_dec(12)).toString(), '1666666667'), 10000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(12)).toString(), '1666666667'), 10000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_dec(12)).toString(), '1666666667'), 10000)

      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_dec(12)).toString(), '5000000000'), 10000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 EUSD.  A, B, C, D withdraw correct EUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(100000, 18)), whale, whale, {
        from: whale,
        value: dec(100000, 'ether')
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct EUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 1m ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(1000000, 18)), whale, whale, {
        from: whale,
        value: dec(1000000, 'ether')
      ...
      */
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).div(_dec(7)).toString(), '1783281733746130'), 100000000000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(7)).toString(), '594427244582043'), 100000000000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_dec(7)).toString(), '445820433436532'), 100000000000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_dec(7)).toString(), '1176470588235290'), 100000000000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. All deposits and liquidations = 100 EUSD.  A, B, C, D withdraw correct EUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(100000, 18)), whale, whale, {
        from: whale,
        value: dec(100000, 'ether')
      ...
      const dennis_ETHWithdrawn = th.getEventArgByName(txD, 'CollGainWithdrawn', '_collAmounts')[0].toString()
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_dec(11)).toString(), '50000000000'), 100000)
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).toString(), '0'), 1000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '0'), 1000)
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct EUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(100000, 18)), whale, whale, {
        from: whale,
        value: dec(100000, 'ether')
      ...
      */
      ...
      const dennis_ETHWithdrawn = th.getEventArgByName(txD, 'CollGainWithdrawn', '_collAmounts')[0].toString()
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_dec(11)).toString(), '276923076923'), 100000000000)
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).div(_dec(11)).toString(), '16722408026'), 10000000000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(11)).toString(), '20903010033'), 100000000000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_dec(11)).toString(), '10451505016'), 100000000000)
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 EUSD. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct EUSD deposit and ETH Gain", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(100000, 18)), whale, whale, {
        from: whale,
        value: dec(100000, 'ether')
      ...
      const dennis_ETHWithdrawn = th.getEventArgByName(txD, 'CollGainWithdrawn', '_collAmounts')[0].toString()
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_dec(6)).toString(), '1666666666666666'), _1e10BN)
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(alice)).div(_dec(6)).toString(), '666666666666666'), _1e10BN)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(6)).toString(), '666666666666666'), _1e10BN)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_dec(6)).toString(), '2000000000000000'), _1e10BN)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_1e14BN).toString(), '50000000'), 100)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_1e14BN).toString(), '50000000'), 100)
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_1e10BN).toString(), '833333333333'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_1e10BN).toString(), '1666666666666'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(erin)).div(_1e10BN).toString(), '2500000000000'), 1000000)
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(erin)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(flyn)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(graham)).toString(), '0'), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(harriet)).toString(), '0'), 100000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      // Defaulter 1 liquidated.  Value of P is 1e18 because debt greater  than eusd in SP.
      await troveManager.liquidate(defaulter_1, {
        from: owner
      });
      ...
      const txLi = await troveManager.liquidate(defaulter_2, {
        from: owner
      });
      ...
      // Expect Bob to withdraw 1% of initial deposit (100 EUSD) and all the liquidated ETH (60 ether)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(10)).toString(), '10000000000'), 1000000)
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      */
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(12)).toString(), dec(100, 6)), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_dec(12)).toString(), dec(200, 6)), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_dec(12)).toString(), dec(300, 6)), 100000)
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(95, 15))))
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(12)).toString(), dec(1, 5)), 100000)
      assert.isAtMost(th.getDifference(bob_ETHWithdrawn, dec(995, 17)), _1e14BN)
    })
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(93, 11))))
      assert.equal(await stabilityPool.currentScale(), '0')
      ...
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(bob)).div(_dec(11)).toString(), dec(1, 6)), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(carol)).div(_dec(11)).toString(), dec(2, 6)), 100000)
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_dec(11)).toString(), dec(3, 6)), 100000)
    ...
    */
    it("withdrawFromSP(): Several deposits of 10000 EUSD span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      // Whale opens Trove with 100k ETH
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(100000, 18)), whale, whale, {
        from: whale,
        value: dec(100000, 'ether')
      ...
      assert.isTrue((await stabilityPool.P()).lt(toBN(dec(1, 13))))
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(95, 11))))
      assert.equal(await stabilityPool.currentScale(), '0')
      ...
      assert.isTrue((await stabilityPool.P()).lt(toBN(dec(1, 17))))
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(1, 15))))
      assert.equal(await stabilityPool.currentScale(), '1')
      ...
      assert.isTrue((await stabilityPool.P()).lt(toBN(dec(81, 10))))
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(79, 10))))
      assert.equal(await stabilityPool.currentScale(), '1')
      ...
      assert.isTrue((await stabilityPool.P()).lt(toBN(dec(69, 14))))
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(67, 14))))
      ...
      assert.equal(await eusdToken.balanceOf(alice), '0')
      assert.equal(await eusdToken.balanceOf(alice), '0')
      assert.equal(await eusdToken.balanceOf(alice), '0')
      // D should withdraw around 0.9999 EUSD, since his deposit of 9999.9 was reduced by a factor of 1e-5
      assert.isAtMost(th.getDifference((await eusdToken.balanceOf(dennis)).div(_dec(12)).toString(), dec(9999)), 100000)
    ...
    it("withdrawFromSP(): Depositor's ETH gain stops increasing after two scale changes", async () => {
      ...
      // Defaulters 1-5 each withdraw up to debt of 9999.9999999 EUSD
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(99999, 17)), defaulter_1, defaulter_1, {
        from: defaulter_1,
        value: dec(100, 'ether')
      })
      ...
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(99999, 17)), defaulter_3, defaulter_3, {
        from: defaulter_3,
        value: dec(100, 'ether')
      })
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(99999, 17)), defaulter_4, defaulter_4, {
        from: defaulter_4,
        value: dec(100, 'ether')
      })
      await borrowerOperations.openTrove([], [], th._100pct, await getOpenTroveEUSDAmount(dec(99999, 17)), defaulter_5, defaulter_5, {
        from: defaulter_5,
        value: dec(100, 'ether')
      })
      ...
      assert.isTrue(txL2.receipt.status)
      // Scale changes and P changes to < 1e(13-5+9) = 1e17
      assert.isTrue((await stabilityPool.P()).lt(toBN(dec(90, 15))))
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(89, 15))))
      assert.equal(await stabilityPool.currentScale(), '1')
      ...
      assert.isTrue(txL3.receipt.status)
      // P decreases to < 1e(17-5) = 1e12
      assert.isTrue((await stabilityPool.P()).lt(toBN(dec(79, 10))))
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(78, 10))))
      assert.equal(await stabilityPool.currentScale(), '1')
      ...
      assert.isTrue(txL4.receipt.status)
      // Scale changes and P changes to < 1e(12-5+9) = 1e16
      assert.isTrue((await stabilityPool.P()).lt(toBN(dec(67, 14))))
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(65, 14))))
      assert.equal(await stabilityPool.currentScale(), '2')

      const alice_ETHGainAt2ndScaleChange = (await stabilityPool.getDepositorCollateralGain(alice)).toString()

      // E deposits 9999.9 EUSD
      await eusdToken.transfer(erin, dec(99999, 17), {
        from: whale
      })
      await stabilityPool.provideToSP(dec(99999, 17), ZERO_ADDRESS, {
        from: erin
      ...
      const txL5 = await troveManager.liquidate(defaulter_5, {
        from: owner
      });
      assert.isTrue(txL5.receipt.status)
      // P decreases to < 1e(16-5) = 1e11
      assert.isTrue((await stabilityPool.P()).lt(toBN(dec(54, 9))))
      assert.isTrue((await stabilityPool.P()).gt(toBN(dec(53, 9))))
      assert.equal(await stabilityPool.currentScale(), '2')
    ...
    it("withdrawFromSP(): Large liquidated coll/debt, deposits and ETH price", async () => {
      ...
      const bobEUSDBalance = await eusdToken.balanceOf(bob)
